...
import com.sunway.ws.module.erp.business.cgjh.bean.CgjhItemBean;

@MyBatisDao
public interface CgjhItemDao extends BaseDao<CgjhItemBean> {
...
//	@SelectKey(statement="call next value for SEQ_INTERFACE", before = true, keyProperty = "id", resultType = long.class)
	public int batchInsert(@Param("list") List<CgjhItemBean> list);
