...
@Table(name="i_erp_cgjh_item_lcb")
@XmlAccessorType(XmlAccessType.FIELD)
public class CgjhItemLcbBean extends BaseBean {
	
	@Transient
	@XmlTransient
	private static final long serialVersionUID = 1630447510315437214L;
	...
	@XmlElement(name = "LCBNO")
	private String lcbno;
	@XmlElement(name = "LDATE")
