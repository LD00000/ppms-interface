...
import com.sunway.ws.module.erp.business.cgjh.bean.CgjhItemZfclBean;

@MyBatisDao
public interface CgjhItemZfclDao extends BaseDao<CgjhItemZfclBean> {
...
//	@SelectKey(statement="call next value for SEQ_INTERFACE", before = true, keyProperty = "id", resultType = long.class)
	public int batchInsert(@Param("list") List<CgjhItemZfclBean> list);
