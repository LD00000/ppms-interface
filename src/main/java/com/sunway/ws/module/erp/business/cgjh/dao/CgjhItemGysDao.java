...
import com.sunway.ws.module.erp.business.cgjh.bean.CgjhItemGysBean;

@MyBatisDao
public interface CgjhItemGysDao extends BaseDao<CgjhItemGysBean> {
...
//	@SelectKey(statement="call next value for SEQ_INTERFACE", before = true, keyProperty = "id", resultType = long.class)
	public int batchInsert(@Param("list") List<CgjhItemGysBean> list);
